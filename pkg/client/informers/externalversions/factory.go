...
type SharedInformerFactory interface {
	...
	Hlf() hlfkungfusoftwarees.Interface
}

func (f *sharedInformerFactory) Hlf() hlfkungfusoftwarees.Interface {
	return hlfkungfusoftwarees.New(f, f.namespace, f.tweakListOptions)
}
