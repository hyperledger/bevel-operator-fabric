...
If you don't have any chaincode packages, you can download them from [the hlf-operator github repository](https://github.com/hyperledger-labs/hlf-operator/tree/main/fixtures/chaincodes/fabcar).
