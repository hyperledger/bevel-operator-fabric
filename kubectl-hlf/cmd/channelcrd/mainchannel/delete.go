...
func (c *deleteCmd) run() error {
	...
	log.Infof("Main channel %s deleted", c.channelOpts.Name)
	return nil
}
func newDeleteMainChannelCmd(out io.Writer, errOut io.Writer) *cobra.Command {
	c := deleteCmd{out: out, errOut: errOut}
	cmd := &cobra.Command{
		Use:   "delete",
		Short: "Delete a main channel",
