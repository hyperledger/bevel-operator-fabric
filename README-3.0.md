...
kubectl hlf ca register --name=org1-ca --user=orderer --secret=ordererpw --type=orderer \
 --enroll-id enroll --enroll-secret=enrollpw --mspid Org1MSP
...
kubectl hlf ordnode create --image=$ORDERER_IMAGE --version=$ORDERER_VERSION \
    --storage-class=standard --enroll-id=orderer --mspid=Org1MSP \
    --enroll-pw=ordererpw --capacity=2Gi --name=org1-orderer0 --ca-name=org1-ca.default \
    --hosts=org1-orderer0.localho.st --admin-hosts=admin-org1-orderer0.localho.st --istio-port=443
