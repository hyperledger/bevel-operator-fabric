...
func (r *FabricOperatorUIReconciler) addFinalizer(reqLogger logr.Logger, m *hlfv1alpha1.FabricOperatorUI) error {
...
func GetOperatorUIState(conf *action.Configuration, config *rest.Config, releaseName string, ns string) (*hlfv1alpha1.FabricOperatorUIStatus, error) {
	...
	r := &hlfv1alpha1.FabricOperatorUIStatus{
...
func (r *FabricOperatorUIReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	reqLogger := r.Log.WithValues("hlf", req.NamespacedName)
	fabricOpConsole := &hlfv1alpha1.FabricOperatorUI{}
...
func (r *FabricOperatorUIReconciler) upgradeChart(
	cfg *action.Configuration,
	err error,
	ns string,
	releaseName string,
	c *HLFOperatorUIChart,
) error {
	inrec, err := json.Marshal(c)
	if err != nil {
		return err
...
func (r *FabricOperatorUIReconciler) setConditionStatus(ctx context.Context, p *hlfv1alpha1.FabricOperatorUI, conditionType hlfv1alpha1.DeploymentStatus, statusFlag bool, err error, statusUnknown bool) (update bool) {
...
func (r *FabricOperatorUIReconciler) updateCRStatusOrFailReconcile(ctx context.Context, log logr.Logger, p *hlfv1alpha1.FabricOperatorUI) (
...
func (r *FabricOperatorUIReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&hlfv1alpha1.FabricOperatorUI{}).
		Owns(&appsv1.Deployment{}).
		Complete(r)
}
func getServiceName(console *hlfv1alpha1.FabricOperatorUI) string {
	return console.Name
}
func (r *FabricOperatorUIReconciler) finalizePeer(reqLogger logr.Logger, console *hlfv1alpha1.FabricOperatorUI) error {
